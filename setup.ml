...
(* OASIS_START *)
(* DO NOT EDIT (digest: fe8fcf23b64fb86d5bc349235512b650) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Fran\195\167ois Thir\195\169 <francois.thire@lsv.fr>"];
          homepage = None;
          bugreports = None;
          synopsis =
            "An experiment to implement different type systems in the same framework";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src/lambda";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "Sig"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src/";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "lambda"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
     ...
     oasis_digest = Some "\221\bE\n\253\166\014x\149\255W\011\167Y\248\189";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
